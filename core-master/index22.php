                                    ...
                                    <div class="col-xl-12 col-md-6 stretch-card grid-margin grid-margin-sm-0 pb-sm-3">
                                        <div class="card bg-danger">
                                            <div class="card-body px-3 py-4">
                                                <div class="d-flex justify-content-between align-items-start">
                                                    <div class="color-card">
                                                        <p class="mb-0 color-card-head">Margen de ventas</p>
                                                        <h2 class="text-white"> $0 .<span class="h5">00</span>
                                                        </h2>
                                                    </div>
                                    ...
                                    <div class="col-xl-12 col-md-6 stretch-card grid-margin grid-margin-sm-0 pb-sm-3 pb-lg-0 pb-xl-3">
                                        <div class="card bg-primary">
                                            <div class="card-body px-3 py-4">
                                                ...
                                                <h6 class="text-white"> $0.0 Since last month</h6>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xl-12 col-md-6 stretch-card pb-sm-3 pb-lg-0">
                                        <div class="card bg-success">
                                            <div class="card-body px-3 py-4">
                                                <div class="d-flex justify-content-between align-items-start">
                                                    <div class="color-card">
                                                        <p class="mb-0 color-card-head">Clientes</p>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-7">
                                                ...
                                                <p class="text-muted"> De ayer Hasta alla <a class="text-muted font-weight-medium pl-2" href="#"><u>See Details</u></a>
                                                </p>
                                            </div>
